...
//https://github.com/MinecrafterHDPT4K/Teste
...
public class Janela extends javax.swing.JFrame {
   ...
   private void botaoVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoVerificarActionPerformed
      ...
      try{
      if(campoNumero.getText() == null){
          throw new Blank("Campo Vazio");
      }
      ...
      if(bandeira){
         ...
         labelPrimoSN.setText("não é primo");      
          ...
          JOptionPane.showMessageDialog(this, "Introduza números", "ERRO", 2);
      }
